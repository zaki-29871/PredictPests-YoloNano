...
from .basic_layers import conv1x1, conv3x3, EP, PEP, FCA, YOLOLayer, SpatialPyramidPooling
from utils.stats import build_targets, to_cpu, non_max_suppression


class YoloNanoSPP(nn.Module):
    def __init__(self, num_classes, image_size):
        super(YoloNanoSPP, self).__init__()
        ...
        self.spp = SpatialPyramidPooling(24, 24)  # output: 208x208x24
